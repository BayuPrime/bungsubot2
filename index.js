...
/////////////////
const BotName = 'BayuPrime'; 
const instagram = 'https://instagram.com/bayu.yudha25'; 
const telegram = 'https://t.me/B4_y0'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by BayuPrime')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by BayuPrime`)
})
